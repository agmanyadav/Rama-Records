      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-black rounded-2xl p-8 w-full max-w-lg border border-yellow-500/20 shadow-2xl max-h-[90vh] overflow-y-auto"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-bold text-yellow-500">Book a Session</h3>
              <button onClick={onClose} className="text-white hover:text-white text-2xl">
            ...
            {success ? (
              <div className="text-center py-10">
                <div className="w-16 h-16 bg-yellow-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <i className="fas fa-check text-yellow-400 text-3xl"></i>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block mb-1 text-sm font-medium text-white">Preferred Date</label>
                  <input
                    type="date"
                    name="preferredDate"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-3 rounded-full text-lg transition-all duration-300 disabled:opacity-50 shadow-lg"
                >
                  {loading ? (
